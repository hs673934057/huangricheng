    ...
    >
     <el-form-item label="店铺社会统一信用码">
      ...
      <el-form-item label="配送费" required>
        <el-input-number v-model="delivery" :min="1" :max="10" label="描述文字" name='delivery'></el-input-number>
      </el-form-item>
      <el-form-item label="起送价" required>
        <el-input-number v-model="price" :min="1" :max="10000" label="描述文字" name='price'></el-input-number>
      </el-form-item>
...
export default {
  ...
  mounted(){
    const {slogan,info,phone,address,name,feature,delivery,price,startTime,endTime,logoUrl,manageUrl,diningUrl}=this.$route.query
